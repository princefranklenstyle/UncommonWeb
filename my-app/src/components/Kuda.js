...
<li>
        ...
        {/*   <li>
            <NavLink to="/our-story" activeClassName="at">
              Our Story
            </NavLink>
          </li>
          <li>
            <NavLink to="/innovation-hub" activeClassName="at">
              Innovation Hub
            </NavLink>
          </li>
          <li>
            <NavLink to="/hire-us" activeClassName="at">
              Hire Us
            </NavLink>
          </li>
          <li>
            <NavLink to="/donate" className="donate" activeClassName="at">
              Donate
            </NavLink>
          </li> */}
        </ul>
